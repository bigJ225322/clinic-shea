...
function pickClaspMechanic({
 ...
 // even for maxillary teeth — which surveys palatal by convention.
...
function rpdCheckRedFlags(caseInput, kennedy, abutmentDesigns) {
 ...
 // and procedure-code conventions (D5760/D5761 partial lab reline,
 // D5710/D5711 rebase, D5213/D5214 remake).
 const existingRpd = pf.existingRpdSameArch;
 if (existingRpd) {
 const cond = pf.existingRpdCondition || "unspecified";
 let recommendation;
 if (cond === "fits-ridge-resorption-only") {
 recommendation = "LAB RELINE (D5760 max / D5761 mand — partial denture lab reline). Take pickup impression with RPD seated, bite registration, ship to lab. Framework and denture teeth retained. Turnaround: ~1 week.";

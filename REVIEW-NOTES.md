...
12. **RPD engine lab-reline codes wrong: D5750/D5751 used for partial-denture reline (6e711a1).** Found while auditing the previous CDT fix (#11). D5750/D5751 are COMPLETE denture reline codes per CDT 2024 — partial-denture lab reline is D5760/D5761. Engine had it wrong in 3 places (step 11 action + axiumEntry + line 2674 recommendation). Also flagged the "Coe-Soft lab-processed D5740/D5741" wording — D5740/D5741 are chairside codes, so "lab-processed" was a contradiction (now reads "CHAIRSIDE SOFT RELINE"). Updated 2 tests that locked in the wrong D5750/D5751 codes.

### Iter 31 cumulative: 11 commits, 12 substantive fixes (1 RPD test, 5 CDT code corrections), all live. Tests 1023/1023 pass. B35 borderline resolved. CDT-code accuracy was the biggest theme of this iter — between commits 78f9408 and 6e711a1, the RPD engine's billing-code mappings are now fully CDT 2024 compliant.
